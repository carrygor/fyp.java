 ...
 * @author 严汉羽
 */
@TableName("up_apps_answer_sheet")
public class UpAppsAnswerSheet extends Model<UpAppsAnswerSheet> implements Serializable {
	...
	public UpAppsAnswerSheet setId(Long id) {
		this.id = id;
		return this;
	}
	...
	public UpAppsAnswerSheet setUserId(Long userId) {
		this.userId = userId;
		return this;
	}
	...
	public UpAppsAnswerSheet setTenantsCompanyId(Long tenantsCompanyId) {
	...
	public UpAppsAnswerSheet setTenantsRegionId(Long tenantsRegionId) {
	...
	public UpAppsAnswerSheet setQuestionnaireId(Long questionnaireId) {
	...
	public UpAppsAnswerSheet setIsAutoSubmit(Integer isAutoSubmit) {
	...
	public UpAppsAnswerSheet setStartTime(Date startTime) {
	...
	public UpAppsAnswerSheet setIsFinished(Integer isFinished) {
	...
	public UpAppsAnswerSheet setFinishTime(Date finishTime) {
	...
	public UpAppsAnswerSheet setFinishQuestionNum(Integer finishQuestionNum) {
	...
	public UpAppsAnswerSheet setFinishRequiredQuestionNum(Integer finishRequiredQuestionNum) {
	...
	public UpAppsAnswerSheet setFinishPrecentage(Float finishPrecentage) {
	...
	public UpAppsAnswerSheet setIsNeedService(Integer isNeedService) {
	...
	public UpAppsAnswerSheet setServiceRecordJson(String serviceRecordJson) {
	...
	public UpAppsAnswerSheet setAnswerSheetJson(String answerSheetJson) {
	...
	public UpAppsAnswerSheet setUserSource(String userSource) {
	...
	public UpAppsAnswerSheet setQuickTag(String quickTag) {
	...
	public UpAppsAnswerSheet setIsDangerous(Integer isDangerous) {
	...
	public UpAppsAnswerSheet setIsSloved(Integer isSloved) {
	...
	public UpAppsAnswerSheet setIsCommented(Integer isCommented) {
	...
	public UpAppsAnswerSheet setServiceType(String serviceType) {
	...
	public UpAppsAnswerSheet setOpenid(String openid) {
		this.openid = openid;
		return this;
	}
	...
	public UpAppsAnswerSheet setOrderSn(String orderSn) {
	...
	public UpAppsAnswerSheet setCookies(String cookies) {
	...
	public UpAppsAnswerSheet setIp(String ip) {
		this.ip = ip;
		return this;
	}
	...
	public UpAppsAnswerSheet setVersion(Integer version) {
	...
	public UpAppsAnswerSheet setLogicDelete(Integer logicDelete) {
	...
	public UpAppsAnswerSheet setAddTime(Date addTime) {
	...
	public UpAppsAnswerSheet setUpdateTime(Date updateTime) {
	...
	public UpAppsAnswerSheet setPhoneNum(String phoneNum) {
	...
	public UpAppsAnswerSheet setEntrance(String entrance) {
	...
	public UpAppsAnswerSheet setBroswer(String broswer) {
