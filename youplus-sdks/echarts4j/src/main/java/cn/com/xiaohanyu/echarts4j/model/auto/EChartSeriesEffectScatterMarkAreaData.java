 ...
 * @author 小汉语
 */
public class EChartSeriesEffectScatterMarkAreaData implements Serializable {
    private static final long serialVersionUID = 1L;

    private EChartSeriesEffectScatterMarkAreaDataReplace0 replace0;

    private EChartSeriesEffectScatterMarkAreaDataReplace1 replace1;


    public EChartSeriesEffectScatterMarkAreaDataReplace0 getReplace0(){
        return replace0;
    }

    public EChartSeriesEffectScatterMarkAreaData setReplace0(EChartSeriesEffectScatterMarkAreaDataReplace0 replace0) {
        this.replace0 = replace0;
        return this;
    }

    public EChartSeriesEffectScatterMarkAreaDataReplace1 getReplace1(){
        return replace1;
    }

    public EChartSeriesEffectScatterMarkAreaData setReplace1(EChartSeriesEffectScatterMarkAreaDataReplace1 replace1) {
