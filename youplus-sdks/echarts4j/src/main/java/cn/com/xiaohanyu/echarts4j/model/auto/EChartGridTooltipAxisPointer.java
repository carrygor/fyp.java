 ...
 * @author 小汉语
 */
public class EChartGridTooltipAxisPointer implements Serializable {
    ...
    private EChartGridTooltipAxisPointerLabel label;
    ...
    public EChartGridTooltipAxisPointer setShadowStyle(ShadowStyle shadowStyle) {
    ...
    public EChartGridTooltipAxisPointer setLineStyle(LineStyle lineStyle) {
    ...
    public EChartGridTooltipAxisPointer setCrossStyle(CrossStyle crossStyle) {
    ...
    public EChartGridTooltipAxisPointer setZ(Number z) {
        this.z = z;
        return this;
    }

    public EChartGridTooltipAxisPointerLabel getLabel(){
        return label;
    }

    public EChartGridTooltipAxisPointer setLabel(EChartGridTooltipAxisPointerLabel label) {
        this.label = label;
        return this;
    }
    ...
    public EChartGridTooltipAxisPointer setType(String type) {
        this.type = type;
        return this;
    }
    ...
    public EChartGridTooltipAxisPointer setAxis(String axis) {
        this.axis = axis;
        return this;
    }
    ...
    public EChartGridTooltipAxisPointer setSnap(Boolean snap) {
        this.snap = snap;
        return this;
    }
