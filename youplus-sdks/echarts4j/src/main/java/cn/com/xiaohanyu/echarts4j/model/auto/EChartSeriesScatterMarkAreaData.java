 ...
 * @author 小汉语
 */
public class EChartSeriesScatterMarkAreaData implements Serializable {
    private static final long serialVersionUID = 1L;

    private EChartSeriesScatterMarkAreaDataReplace0 replace0;

    private EChartSeriesScatterMarkAreaDataReplace1 replace1;


    public EChartSeriesScatterMarkAreaDataReplace0 getReplace0(){
        return replace0;
    }

    public EChartSeriesScatterMarkAreaData setReplace0(EChartSeriesScatterMarkAreaDataReplace0 replace0) {
        this.replace0 = replace0;
        return this;
    }

    public EChartSeriesScatterMarkAreaDataReplace1 getReplace1(){
        return replace1;
    }

    public EChartSeriesScatterMarkAreaData setReplace1(EChartSeriesScatterMarkAreaDataReplace1 replace1) {
