 ...
 * @author 小汉语
 */
public class EChartSeriesPictorialBarMarkLineData implements Serializable {
    private static final long serialVersionUID = 1L;

    private EChartSeriesPictorialBarMarkLineDataReplace0 replace0;

    private EChartSeriesPictorialBarMarkLineDataReplace1 replace1;


    public EChartSeriesPictorialBarMarkLineDataReplace0 getReplace0(){
        return replace0;
    }

    public EChartSeriesPictorialBarMarkLineData setReplace0(EChartSeriesPictorialBarMarkLineDataReplace0 replace0) {
        this.replace0 = replace0;
        return this;
    }

    public EChartSeriesPictorialBarMarkLineDataReplace1 getReplace1(){
        return replace1;
    }

    public EChartSeriesPictorialBarMarkLineData setReplace1(EChartSeriesPictorialBarMarkLineDataReplace1 replace1) {
