 ...
 * @author 小汉语
 */
public class EChartVisualMapPiecewiseController implements Serializable {
    ...
    public EChartVisualMapPiecewiseController setOutOfRange(Object outOfRange) {
    ...
    public EChartVisualMapPiecewiseController setInRange(Object inRange) {
