 ...
 * @author 小汉语
 */
public class EChartSeriesGraphMarkLineData implements Serializable {
    private static final long serialVersionUID = 1L;

    private EChartSeriesGraphMarkLineDataReplace0 replace0;

    private EChartSeriesGraphMarkLineDataReplace1 replace1;


    public EChartSeriesGraphMarkLineDataReplace0 getReplace0(){
        return replace0;
    }

    public EChartSeriesGraphMarkLineData setReplace0(EChartSeriesGraphMarkLineDataReplace0 replace0) {
        this.replace0 = replace0;
        return this;
    }

    public EChartSeriesGraphMarkLineDataReplace1 getReplace1(){
        return replace1;
    }

    public EChartSeriesGraphMarkLineData setReplace1(EChartSeriesGraphMarkLineDataReplace1 replace1) {
