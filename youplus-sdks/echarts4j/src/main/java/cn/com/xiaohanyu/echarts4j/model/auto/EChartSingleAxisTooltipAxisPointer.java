 ...
 * @author 小汉语
 */
public class EChartSingleAxisTooltipAxisPointer implements Serializable {
    ...
    private EChartSingleAxisTooltipAxisPointerLabel label;
    ...
    public EChartSingleAxisTooltipAxisPointer setShadowStyle(ShadowStyle shadowStyle) {
    ...
    public EChartSingleAxisTooltipAxisPointer setLineStyle(LineStyle lineStyle) {
    ...
    public EChartSingleAxisTooltipAxisPointer setCrossStyle(CrossStyle crossStyle) {
    ...
    public EChartSingleAxisTooltipAxisPointer setZ(Number z) {
        this.z = z;
        return this;
    }

    public EChartSingleAxisTooltipAxisPointerLabel getLabel(){
        return label;
    }

    public EChartSingleAxisTooltipAxisPointer setLabel(EChartSingleAxisTooltipAxisPointerLabel label) {
        this.label = label;
        return this;
    }
    ...
    public EChartSingleAxisTooltipAxisPointer setType(String type) {
        this.type = type;
        return this;
    }
    ...
    public EChartSingleAxisTooltipAxisPointer setAxis(String axis) {
        this.axis = axis;
        return this;
    }
    ...
    public EChartSingleAxisTooltipAxisPointer setSnap(Boolean snap) {
        this.snap = snap;
        return this;
    }
