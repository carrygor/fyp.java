 ...
 * @author 小汉语
 */
public class EChartSeriesCandlestickMarkAreaData implements Serializable {
    private static final long serialVersionUID = 1L;

    private EChartSeriesCandlestickMarkAreaDataReplace0 replace0;

    private EChartSeriesCandlestickMarkAreaDataReplace1 replace1;


    public EChartSeriesCandlestickMarkAreaDataReplace0 getReplace0(){
        return replace0;
    }

    public EChartSeriesCandlestickMarkAreaData setReplace0(EChartSeriesCandlestickMarkAreaDataReplace0 replace0) {
        this.replace0 = replace0;
        return this;
    }

    public EChartSeriesCandlestickMarkAreaDataReplace1 getReplace1(){
        return replace1;
    }

    public EChartSeriesCandlestickMarkAreaData setReplace1(EChartSeriesCandlestickMarkAreaDataReplace1 replace1) {
