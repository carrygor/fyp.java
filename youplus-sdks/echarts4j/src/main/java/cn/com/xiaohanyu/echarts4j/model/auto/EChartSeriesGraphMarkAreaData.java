 ...
 * @author 小汉语
 */
public class EChartSeriesGraphMarkAreaData implements Serializable {
    private static final long serialVersionUID = 1L;

    private EChartSeriesGraphMarkAreaDataReplace0 replace0;

    private EChartSeriesGraphMarkAreaDataReplace1 replace1;


    public EChartSeriesGraphMarkAreaDataReplace0 getReplace0(){
        return replace0;
    }

    public EChartSeriesGraphMarkAreaData setReplace0(EChartSeriesGraphMarkAreaDataReplace0 replace0) {
        this.replace0 = replace0;
        return this;
    }

    public EChartSeriesGraphMarkAreaDataReplace1 getReplace1(){
        return replace1;
    }

    public EChartSeriesGraphMarkAreaData setReplace1(EChartSeriesGraphMarkAreaDataReplace1 replace1) {
