 ...
 * @author 小汉语
 */
public class EChartSeriesPictorialBarMarkAreaData implements Serializable {
    private static final long serialVersionUID = 1L;

    private EChartSeriesPictorialBarMarkAreaDataReplace0 replace0;

    private EChartSeriesPictorialBarMarkAreaDataReplace1 replace1;


    public EChartSeriesPictorialBarMarkAreaDataReplace0 getReplace0(){
        return replace0;
    }

    public EChartSeriesPictorialBarMarkAreaData setReplace0(EChartSeriesPictorialBarMarkAreaDataReplace0 replace0) {
        this.replace0 = replace0;
        return this;
    }

    public EChartSeriesPictorialBarMarkAreaDataReplace1 getReplace1(){
        return replace1;
    }

    public EChartSeriesPictorialBarMarkAreaData setReplace1(EChartSeriesPictorialBarMarkAreaDataReplace1 replace1) {
