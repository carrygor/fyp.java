 ...
 * @author 小汉语
 */
public class EChartSeriesBarMarkLineData implements Serializable {
    private static final long serialVersionUID = 1L;

    private EChartSeriesBarMarkLineDataReplace0 replace0;

    private EChartSeriesBarMarkLineDataReplace1 replace1;


    public EChartSeriesBarMarkLineDataReplace0 getReplace0(){
        return replace0;
    }

    public EChartSeriesBarMarkLineData setReplace0(EChartSeriesBarMarkLineDataReplace0 replace0) {
        this.replace0 = replace0;
        return this;
    }

    public EChartSeriesBarMarkLineDataReplace1 getReplace1(){
        return replace1;
    }

    public EChartSeriesBarMarkLineData setReplace1(EChartSeriesBarMarkLineDataReplace1 replace1) {
