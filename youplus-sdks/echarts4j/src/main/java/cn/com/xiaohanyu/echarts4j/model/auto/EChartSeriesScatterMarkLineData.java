 ...
 * @author 小汉语
 */
public class EChartSeriesScatterMarkLineData implements Serializable {
    private static final long serialVersionUID = 1L;

    private EChartSeriesScatterMarkLineDataReplace0 replace0;

    private EChartSeriesScatterMarkLineDataReplace1 replace1;


    public EChartSeriesScatterMarkLineDataReplace0 getReplace0(){
        return replace0;
    }

    public EChartSeriesScatterMarkLineData setReplace0(EChartSeriesScatterMarkLineDataReplace0 replace0) {
        this.replace0 = replace0;
        return this;
    }

    public EChartSeriesScatterMarkLineDataReplace1 getReplace1(){
        return replace1;
    }

    public EChartSeriesScatterMarkLineData setReplace1(EChartSeriesScatterMarkLineDataReplace1 replace1) {
