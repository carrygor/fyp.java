 ...
 * @author 小汉语
 */
public class EChartSeriesBarMarkAreaData implements Serializable {
    private static final long serialVersionUID = 1L;

    private EChartSeriesBarMarkAreaDataReplace0 replace0;

    private EChartSeriesBarMarkAreaDataReplace1 replace1;


    public EChartSeriesBarMarkAreaDataReplace0 getReplace0(){
        return replace0;
    }

    public EChartSeriesBarMarkAreaData setReplace0(EChartSeriesBarMarkAreaDataReplace0 replace0) {
        this.replace0 = replace0;
        return this;
    }

    public EChartSeriesBarMarkAreaDataReplace1 getReplace1(){
        return replace1;
    }

    public EChartSeriesBarMarkAreaData setReplace1(EChartSeriesBarMarkAreaDataReplace1 replace1) {
