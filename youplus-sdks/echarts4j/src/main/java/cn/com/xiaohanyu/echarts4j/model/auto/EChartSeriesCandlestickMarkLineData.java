 ...
 * @author 小汉语
 */
public class EChartSeriesCandlestickMarkLineData implements Serializable {
    private static final long serialVersionUID = 1L;

    private EChartSeriesCandlestickMarkLineDataReplace0 replace0;

    private EChartSeriesCandlestickMarkLineDataReplace1 replace1;


    public EChartSeriesCandlestickMarkLineDataReplace0 getReplace0(){
        return replace0;
    }

    public EChartSeriesCandlestickMarkLineData setReplace0(EChartSeriesCandlestickMarkLineDataReplace0 replace0) {
        this.replace0 = replace0;
        return this;
    }

    public EChartSeriesCandlestickMarkLineDataReplace1 getReplace1(){
        return replace1;
    }

    public EChartSeriesCandlestickMarkLineData setReplace1(EChartSeriesCandlestickMarkLineDataReplace1 replace1) {
