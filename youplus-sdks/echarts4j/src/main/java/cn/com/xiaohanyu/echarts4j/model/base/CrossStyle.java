...
public class CrossStyle implements Serializable {
    ...
    public CrossStyle setShadowOffsetX(Number shadowOffsetX) {
    ...
    public CrossStyle setShadowOffsetY(Number shadowOffsetY) {
    ...
    public CrossStyle setShadowBlur(Number shadowBlur) {
    ...
    public CrossStyle setOpacity(Number opacity) {
    ...
    public CrossStyle setWidth(Number width) {
        this.width = width;
        return this;
    }
    ...
    public CrossStyle setType(String type) {
        this.type = type;
        return this;
    }
