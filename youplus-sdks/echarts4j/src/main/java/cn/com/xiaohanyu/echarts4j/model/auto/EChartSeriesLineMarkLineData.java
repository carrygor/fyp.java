 ...
 * @author 小汉语
 */
public class EChartSeriesLineMarkLineData implements Serializable {
    private static final long serialVersionUID = 1L;

    private EChartSeriesLineMarkLineDataReplace0 replace0;

    private EChartSeriesLineMarkLineDataReplace1 replace1;


    public EChartSeriesLineMarkLineDataReplace0 getReplace0(){
        return replace0;
    }

    public EChartSeriesLineMarkLineData setReplace0(EChartSeriesLineMarkLineDataReplace0 replace0) {
        this.replace0 = replace0;
        return this;
    }

    public EChartSeriesLineMarkLineDataReplace1 getReplace1(){
        return replace1;
    }

    public EChartSeriesLineMarkLineData setReplace1(EChartSeriesLineMarkLineDataReplace1 replace1) {
