 ...
 * @author 小汉语
 */
public class EChartTooltipAxisPointer implements Serializable {
    ...
    private EChartTooltipAxisPointerLabel label;
    ...
    public EChartTooltipAxisPointer setShadowStyle(ShadowStyle shadowStyle) {
    ...
    public EChartTooltipAxisPointer setLineStyle(LineStyle lineStyle) {
    ...
    public EChartTooltipAxisPointer setCrossStyle(CrossStyle crossStyle) {
    ...
    public EChartTooltipAxisPointer setZ(Number z) {
        this.z = z;
        return this;
    }

    public EChartTooltipAxisPointerLabel getLabel(){
        return label;
    }

    public EChartTooltipAxisPointer setLabel(EChartTooltipAxisPointerLabel label) {
        this.label = label;
        return this;
    }
    ...
    public EChartTooltipAxisPointer setType(String type) {
        this.type = type;
        return this;
    }
    ...
    public EChartTooltipAxisPointer setAxis(String axis) {
        this.axis = axis;
        return this;
    }
    ...
    public EChartTooltipAxisPointer setSnap(Boolean snap) {
        this.snap = snap;
        return this;
    }
