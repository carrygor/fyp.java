 ...
 * @author 小汉语
 */
public class EChartSeriesBoxplotMarkAreaData implements Serializable {
    private static final long serialVersionUID = 1L;

    private EChartSeriesBoxplotMarkAreaDataReplace0 replace0;

    private EChartSeriesBoxplotMarkAreaDataReplace1 replace1;


    public EChartSeriesBoxplotMarkAreaDataReplace0 getReplace0(){
        return replace0;
    }

    public EChartSeriesBoxplotMarkAreaData setReplace0(EChartSeriesBoxplotMarkAreaDataReplace0 replace0) {
        this.replace0 = replace0;
        return this;
    }

    public EChartSeriesBoxplotMarkAreaDataReplace1 getReplace1(){
        return replace1;
    }

    public EChartSeriesBoxplotMarkAreaData setReplace1(EChartSeriesBoxplotMarkAreaDataReplace1 replace1) {
