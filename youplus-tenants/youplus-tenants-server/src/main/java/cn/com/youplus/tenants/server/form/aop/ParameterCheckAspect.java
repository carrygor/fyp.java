...
public class ParameterCheckAspect {
    ...
    @Autowired
    private TenantsParameterCheckOption tenantsParameterCheckOption;

    // 定义切点
    @Pointcut("within(cn.com.youplus.tenants.server.controller..*)")
    public void check() {
    }
    ...
    public Object checkIsValid(ProceedingJoinPoint joinPoint) throws Throwable {
        Object object = null;
        // 参数校验，未抛出异常表示验证OK
        tenantsParameterCheckOption.checkValid(joinPoint);
