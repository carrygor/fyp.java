 ...
 */
@TableEntity(name = "ts_answer_sheet_cookies")
public class TsAnswerSheetCookies  extends TableStoreBaseModel{

    @TableKey(type = PrimaryKeyTypeObject.STRING)
    private String questionnaireIdCookies;
    ...
    public String getQuestionnaireIdCookies() {
        return questionnaireIdCookies;
    }

    public void setQuestionnaireIdCookies(String questionnaireIdCookies) {
        this.questionnaireIdCookies = questionnaireIdCookies;
    }
