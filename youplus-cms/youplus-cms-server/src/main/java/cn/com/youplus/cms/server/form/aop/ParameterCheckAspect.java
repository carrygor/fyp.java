package cn.com.youplus.cms.server.form.aop;
...
public class ParameterCheckAspect {
    ...
    @Autowired
    private CmsParameterCheckOption cmsParameterCheckOption;

    // 定义切点
    @Pointcut("within(cn.com.youplus.cms.server.controller..*)")
    public void check() {
    }
    ...
    public Object checkIsValid(ProceedingJoinPoint joinPoint) throws Throwable {
        Object object = null;
        // 参数校验，未抛出异常表示验证OK
        cmsParameterCheckOption.checkValid(joinPoint);
