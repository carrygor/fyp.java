package cn.com.youplus.thirdparty.server.controller;

import cn.com.youplus.common.model.base.BaseResponse;
import cn.com.youplus.tenants.common.exception.handler.ThirdpartExceptionHandler;
...
public abstract class SuperController {
    ...
    public BaseResponse exceptionRealHandler(HttpServletRequest request, HttpServletResponse response, Exception exception) throws IOException {
        BaseResponse baseResponse = new ThirdpartExceptionHandler().handle(exception);
