...
public class gz友谊 {
    ...
    private static Logger logger = Logger.getLogger(gz友谊.class);
    ...
    private static String companyName = "广州友谊商店";
    ...
    public void testAddQuestionnaire() throws Exception {
        URL schemaUrl = gz友谊.class.getResource("/gzyouyi.json");
        if (schemaUrl == null) {
